module Pipeline_CPU(
    ...
    wire[3:0] ALU_control_ID,MemRW_ID,MemRW_out_IDEX,MemRW_out_EXMem;
    ...
    wire zero_out_EX;
    wire[31:0] PC_out_EXMem,PC4_out_EXMem,ALU_out_EXMem,Rs2_out_EXMem;
    ...
    wire RegWrite_out_MemWB, Auipc,Auipc_out_IDEX,Half,Byte,Sign_Load,Half_out_IDEX,Byte_out_IDEX,Sign_Load_out_IDEX;
    wire Half_out_EX,Byte_out_EX,Sign_out_EX;
    wire Half_out_EXMem,Byte_out_EXMem,Sign_out_EXMem;
    wire [31:0] Imm_out_MemWB,Imm_out_EXMen;
    Pipeline_IF u1(
        .clk_IF   (clk),
        .rst_IF   (rst),
        .en_IF    (1'b1),
