...
#
# Generated by export_simulation on Wed May 31 16:38:53 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './RAM_B_0.sh' script.

./RAM_B_0.sh -reset_run
...
./RAM_B_0.sh -noclean_files

For more information on the script, please type './RAM_B_0.sh -help'.
