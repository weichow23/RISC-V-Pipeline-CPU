...
#
# Generated by export_simulation on Tue Mar 21 04:32:52 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './SCPU_more_0.sh' script.

./SCPU_more_0.sh -reset_run
...
./SCPU_more_0.sh -noclean_files

For more information on the script, please type './SCPU_more_0.sh -help'.
