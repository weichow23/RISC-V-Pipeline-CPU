...
#
# Generated by export_simulation on Wed Mar 22 19:00:28 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './SCPU_more_int_0.sh' script.

./SCPU_more_int_0.sh -reset_run
...
./SCPU_more_int_0.sh -noclean_files

For more information on the script, please type './SCPU_more_int_0.sh -help'.
