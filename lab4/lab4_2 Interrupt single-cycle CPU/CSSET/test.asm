...
add x0 x0 x0 #换成FFFFFFFF 乱写的一个指令，会被识别为非法 =
jal zero, loop2

L21:
lw x9, 0x60(x17) # SW[4: 3]=11, 从内存取预存七段图形 0608A483
sw x9, 0x0(x4) # SW[4: 3]=11, 显示七段图形  00922023	
# addi x31, zero, 0x150
# jalr zero, x31, 0x24 #jump to pc 0x174
add x0 x0 x0 ##00000073  ：ecall 
jal zero, loop2
addi x31, zero, 0x1b0
jalr zero, x31, 0x8 #jump to pc 0x1b8
